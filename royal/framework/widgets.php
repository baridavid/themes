...
class null_instagram_widget extends WP_Widget {
    ...
    function null_instagram_widget() {
        ...
        parent::__construct('null-instagram-feed', __('Instagram', $this->wpiwdomain), $widget_ops);
    }
    ...
    function form($instance) {
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('slider'); ?>"><?php _e('Carousel', $this->wpiwdomain); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo $this->get_field_id('spacing'); ?>"><?php _e('Without spacing', $this->wpiwdomain); ?></label>
        </p>
        <?php
